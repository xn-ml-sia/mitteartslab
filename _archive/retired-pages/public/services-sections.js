...
export const SERVICES_SECTIONS = [
  {
    ...
    effect: 1,
    layout: 'content--left',
    image: '/public/assets/services/raw-gradients-ggzjvx-n.jpg',
  ...
  },
  {
    ...
    image: '/public/assets/services/raw-gradients-ldrx5uab.jpg',
  ...
  },
  {
    ...
    image: '/public/assets/services/raw-illustrations-n8d3n8zf.jpg',
    ...
    headlineHtml: `
      ...
      <span class="type__expand type__expand--mini">
        <span class="type__expand-img type__expand-img--tiny">
          <span class="type__expand-img-inner" style="background-image: url('/public/assets/services/raw-gradients-fscayqib.jpg');" role="img" aria-label="project engagement"></span>
        </span>
      </span>
      sprint for launch,
      <span class="type__expand type__expand--mini">
        <span class="type__expand-img type__expand-img--tiny">
          <span class="type__expand-img-inner" style="background-image: url('/public/assets/services/raw-gradients-ljs0kzkm.jpg');" role="img" aria-label="system retainer"></span>
        </span>
      </span>
      a system,<br />
      or a
      <span class="type__expand type__expand--mini">
        <span class="type__expand-img type__expand-img--tiny">
          <span class="type__expand-img-inner" style="background-image: url('/public/assets/services/raw-illustrations-lzfqw6-v.jpg');" role="img" aria-label="team workshop"></span>
        </span>
      </span>
      workshop<br />
      ...
      <span class="type__expand type__expand--mini">
        <span class="type__expand-img type__expand-img--tiny">
          <span class="type__expand-img-inner" style="background-image: url('/public/assets/services/raw-gradients-ggzjvx-n.jpg');" role="img" aria-label="collaboration"></span>
        </span>
      </span>
      what you are<br />
